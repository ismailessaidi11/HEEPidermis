 ...
 *
 *
 * This file tests the CIC filter by comparing the output of the filter
 * with a ground truth.
 *
 * This example is copied from the example_cic in X-HEEP and adapted the
 * base address of the peripheral to the one used in HEEPidermis.
 */
